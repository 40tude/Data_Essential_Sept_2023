...
-- CTRL + L pour sélectionner une ligne puis click droit et Run Selected Query
CREATE TABLE
  posts (
    title VARCHAR(150),
    content TEXT,
...
-- Je m'en sors dans le terminal en lancant "sqlite3 tmp.sqlite" et en tapant
ALTER TABLE posts
DROP content;

-- À vérifier
-- N'a pas l'air de marcher dans VSCode
-- Fonctionne dans terminal
